    ...
    <div class="p-6 lg:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                ...
                {{-- Mengakses data dari computed property --}}
                <p class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-2">{{ $this->stats['totalProdi'] }}</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h3 class="font-bold text-gray-900 dark:text-white">Total User Prodi</h3>
                <p class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-2">{{ $this->stats['totalUserProdi'] }}</p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                <h3 class="font-bold text-gray-900 dark:text-white">Total Ruangan</h3>
                <p class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-2">{{ $this->stats['totalRuangan'] }}</p>
            </div>
        </div>
