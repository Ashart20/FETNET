<div>
    ...
    <x-mary-modal wire:model="activityModal" title="{{ $activityId ? 'Edit' : 'Tambah' }} Aktivitas" separator>
        <x-mary-form wire:submit="store">
            <div class="space-y-4">
                {{-- Menggantikan TomSelect dengan komponen bawaan Mary UI --}}
                ...
                <x-mary-select label="Pilih Kelompok Mahasiswa" wire:model="student_group_id" :options="$studentGroups" option-label="nama_kelompok" placeholder="-- Pilih --" />
