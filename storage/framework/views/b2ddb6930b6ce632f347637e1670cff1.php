...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Hasil Simulasi Jadwal','subtitle' => 'Lihat dan terapkan hasil dari proses generate jadwal untuk cluster Anda.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Refresh Daftar','icon' => 'o-arrow-path','spinner' => 'refreshList'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'refreshList','class' => 'btn-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Hapus Semua','icon' => 'o-exclamation-triangle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'deleteAllSimulations','wire:confirm' => 'ANDA YAKIN? Semua hasil simulasi untuk cluster ini akan dihapus secara permanen. Aksi ini tidak bisa dibatalkan.','class' => 'btn-error']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php endif; ?>
    ...
    <div class="mt-4">
        <!--[if BLOCK]><![endif]--><?php if(empty($simulations)): ?>
...
<?php $component = Mary\View\Components\Alert::resolve(['title' => 'Belum Ada Hasil','description' => 'Anda belum pernah menjalankan simulasi, atau prosesnya belum selesai. Silakan mulai dari halaman \'Generate Jadwal\'.','icon' => 'o-information-circle'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                <div class="divide-y divide-base-200">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $simulations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $simulation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $component = Mary\View\Components\ListItem::resolve(['item' => $simulation,'noSeparator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                             <?php $__env->slot('value', null, []); ?> 
                                <div class="font-bold"><?php echo e($simulation['name']); ?></div>
                                <div class="text-xs opacity-70">Dibuat pada: <?php echo e($simulation['created_at']); ?></div>
                             <?php $__env->endSlot(); ?>
                             <?php $__env->slot('actions', null, []); ?> 
                                <div class="flex items-center gap-2">
                                    <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Lihat Hasil','link' => $simulation['url'],'icon' => 'o-arrow-top-right-on-square'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['target' => '_blank','class' => 'btn-ghost btn-sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php endif; ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Terapkan Jadwal Ini','icon' => 'o-check-badge','spinner' => 'applySimulation'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-success btn-sm','wire:click' => 'applySimulation(\''.e($simulation['folder']).'\')','wire:confirm' => 'PERHATIAN!|Anda akan menimpa jadwal resmi untuk semua prodi di cluster ini.|Aksi ini tidak bisa dibatalkan. Lanjutkan?']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'deleteSimulation(\''.e($simulation['folder']).'\')','wire:confirm' => 'Apakah Anda yakin ingin menghapus simulasi ini secara permanen?','class' => 'btn-error btn-sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
</div><?php /**PATH /home/ashart20/FETNET/resources/views/livewire/cluster/view-simulations.blade.php ENDPATH**/ ?>