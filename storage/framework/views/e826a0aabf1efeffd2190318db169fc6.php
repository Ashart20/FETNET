    ...
    <div class="p-6 lg:p-8">
        ...
        <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">
                Anda login sebagai admin untuk Program Studi: <strong><?php echo e(auth()->user()->prodi->nama_prodi ?? 'N/A'); ?></strong>.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border dark:border-gray-700">
                ...
                <p class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-2"><?php echo e($this->stats['totalDosen']); ?></p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border dark:border-gray-700">
                <h3 class="font-bold text-gray-900 dark:text-white">Total Mata Kuliah</h3>
                <p class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-2"><?php echo e($this->stats['totalMatkul']); ?></p>
            </div>
            <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border dark:border-gray-700">
                <h3 class="font-bold text-gray-900 dark:text-white">Total Aktivitas</h3>
                <p class="text-3xl font-extrabold text-indigo-600 dark:text-indigo-400 mt-2"><?php echo e($this->stats['totalAktivitas']); ?></p>
            </div>
        </div>
        ...
        <div class="mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-4">
                <a href="<?php echo e(route('prodi.teachers')); ?>" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <a href="<?php echo e(route('prodi.subjects')); ?>" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <a href="<?php echo e(route('prodi.student-groups')); ?>" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <a href="<?php echo e(route('prodi.activities')); ?>" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <a href="<?php echo e(route('prodi.teacher-constraints')); ?>" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <a href="<?php echo e(route('prodi.student-group-constraints')); ?>" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
        ...
        <div class="mt-8 p-6 lg:p-8 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
            ...
            <form action="<?php echo e(route('prodi.generate')); ?>" method="POST" class="mt-4">
                <?php echo csrf_field(); ?>
