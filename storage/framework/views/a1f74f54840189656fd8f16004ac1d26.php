...
<div class="py-2" style="padding-left: <?php echo e($level * 25); ?>px;">
    <div class="flex items-center justify-between w-full p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800/50">

        
        <div class="flex items-center gap-3">
            <span class="font-semibold text-gray-700 dark:text-gray-300"><?php echo e($group->nama_kelompok); ?></span>

            
            <!--[if BLOCK]><![endif]--><?php if($group->jumlah_mahasiswa > 0): ?>
...
<?php $component = Mary\View\Components\Badge::resolve(['value' => $group->jumlah_mahasiswa] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'badge-primary badge-sm','icon' => 'o-users']); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['@click' => '$wire.edit('.e($group->id).')','class' => 'btn-xs btn-ghost text-yellow-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['icon' => 'o-plus','tooltip' => 'Tambah Sub-item'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['@click' => '$wire.create('.e($group->id).')','class' => 'btn-xs btn-ghost text-green-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'delete('.e($group->id).')','wire:confirm' => 'Yakin ingin menghapus \''.e($group->nama_kelompok).'\' beserta semua sub-kelompoknya?','class' => 'btn-xs btn-ghost text-red-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php endif; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($group->childrenRecursive && $group->childrenRecursive->isNotEmpty()): ?>
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH /Volumes/EXCHANGE/WebDev/FetAS/resources/views/livewire/prodi/partials/student-group-item.blade.php ENDPATH**/ ?>