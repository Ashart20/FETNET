<div>
    <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Manajemen Batasan Waktu Dosen</h1>
        <p class="mt-2 text-gray-600 dark:text-gray-400">Pilih dosen, lalu klik pada slot waktu untuk menandainya sebagai 'tidak tersedia' (merah).</p>
        ...
        <div class="my-4">
            <label for="teacher" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Pilih Dosen:</label>
            <select wire:model.live="selectedTeacherId" id="teacher" class="mt-1 block w-full md:w-1/3 pl-3 pr-10 py-2 text-base border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
        ...
        <div wire:loading wire:target="selectedTeacherId" class="text-center text-gray-500 dark:text-gray-400 my-4">
...
</div><?php /**PATH /Volumes/EXCHANGE/WebDev/FetAS/resources/views/livewire/prodi/manage-teacher-constraints.blade.php ENDPATH**/ ?>