...
<?php endif; ?>
<?php $component->withAttributes(['wire:submit.prevent' => 'store']); ?>
    <div class="space-y-4">
        
        <?php if (isset($component)) { $__componentOriginalf51438a7488970badd535e5f203e0c1b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf51438a7488970badd535e5f203e0c1b = $attributes; } ?>
<?php $component = Mary\View\Components\Input::resolve(['label' => 'Nama Kelompok Mahasiswa'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'nama_kelompok','placeholder' => 'Contoh: Kelas A, Rombel 1']); ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Input::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'angkatan','type' => 'text','placeholder' => 'Contoh: 2024']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf51438a7488970badd535e5f203e0c1b)): ?>
<?php $attributes = $__attributesOriginalf51438a7488970badd535e5f203e0c1b; ?>
...
<?php $component = Mary\View\Components\Select::resolve(['label' => 'Bagian dari Kelompok','options' => $parentGroups,'optionValue' => 'id','optionLabel' => 'nama_kelompok','placeholder' => 'Pilih kelompok induk (opsional)','hint' => 'Pilih \'Tidak Ada\' untuk kelompok utama.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'parent_id']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
        ...
        <?php if (isset($component)) { $__componentOriginald64144c2287634503c73cd4803d6e578 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald64144c2287634503c73cd4803d6e578 = $attributes; } ?>
<?php $component = Mary\View\Components\Select::resolve(['label' => 'Bagian dari Kelompok','options' => $parentGroups->map(fn($g) => ['id' => $g->id, 'nama_kelompok' => $g->nama_kelompok . ($g->angkatan ? ' (' . $g->angkatan . ')' : '') ]),'optionValue' => 'id','optionLabel' => 'nama_kelompok','placeholder' => 'Pilih kelompok induk (opsional)','hint' => 'Pilih \'Tidak Ada\' untuk kelompok utama.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-select'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php endif; ?><?php /**PATH /home/ashart20/FETNET/resources/views/livewire/prodi/student-group-modal.blade.php ENDPATH**/ ?>