...
<?php $component = Mary\View\Components\Header::resolve(['title' => 'Generate Jadwal Otomatis','subtitle' => 'Mulai proses pembuatan jadwal untuk semua prodi di bawah fakultas Anda.'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Card::resolve(['title' => 'Mulai Proses','shadow' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                <?php endif; ?>
                 ...
                 <?php $__env->slot('actions', null, []); ?> 
                    <form action="<?php echo e(route('fakultas.generate.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Mulai Generate untuk Semua Prodi','icon' => 'o-bolt','spinner' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'btn-success']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH /Volumes/EXCHANGE/WebDev/FetAS/resources/views/livewire/fakultas/generate/index.blade.php ENDPATH**/ ?>