        ...
        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $jadwal; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hari => $jadwalHarian): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-sm text-left">
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $jadwalHarian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr wire:key="<?php echo e($item->id); ?>" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            <td class="px-6 py-4 whitespace-nowrap text-gray-600 dark:text-gray-400 font-mono"><?php echo e(optional($item->timeSlot)->start_time ? \Carbon\Carbon::parse($item->timeSlot->start_time)->format('H:i') : '-'); ?> - <?php echo e(optional($item->timeSlot)->end_time ? \Carbon\Carbon::parse($item->timeSlot->end_time)->format('H:i') : '-'); ?></td>
