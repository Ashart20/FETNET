...
<?php $component = Mary\View\Components\Choices::resolve(['label' => 'Select prodi','options' => $prodisSearchable,'searchFunction' => 'search','debounce' => '300ms','minChars' => '2','single' => true,'searchable' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes(['wire:model.live' => 'prodi_searchable_id','placeholder' => 'Select prodi']); ?>
                ...
                <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('item', function($prodi) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
...
<?php $component = Mary\View\Components\ListItem::resolve(['item' => $prodi] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                     ...
                     <?php $__env->slot('value', null, []); ?> 
                        <?php echo e($prodi->kode); ?>-<?php echo e($prodi->nama_prodi); ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $activity->preferredRooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php if (isset($component)) { $__componentOriginal4f015fb6508e425790bdb8f79792e6ed = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal4f015fb6508e425790bdb8f79792e6ed = $attributes; } ?>
<?php $component = Mary\View\Components\Badge::resolve(['value' => $room->nama_ruangan.', kapasitas: '.$room->kapasitas] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('mary-badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
