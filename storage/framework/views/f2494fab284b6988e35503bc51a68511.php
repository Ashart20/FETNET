...
<?php $component = Mary\View\Components\Button::resolve(['label' => 'Tambah Kelompok Baru','icon' => 'o-plus','spinner' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn-primary','wire:click' => 'create()']); ?>
...
<?php $component = Mary\View\Components\Modal::resolve(['title' => ''.e($studentGroupId ? 'Edit Kelompok Mahasiswa' : 'Tambah Kelompok Mahasiswa Baru').'','subtitle' => 'Lengkapi detail kelompok mahasiswa','separator' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Mary\View\Components\Table::resolve(['headers' => $this->headers(),'rows' => $studentGroups,'striped' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['@row-click' => 'alert($event.detail.nama_kelompok)']); ?> 
            
            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('parent_group_name', function($studentGroup) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <?php echo e($studentGroup->parent_group_name); ?>

            <?php }); ?>

            
            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('students_count', function($studentGroup) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <?php echo e($studentGroup->students_count); ?> Mahasiswa
            <?php }); ?>

            <?php $__bladeCompiler = $__bladeCompiler ?? null; $loop = null; $__env->slot('actions', function($studentGroup) use ($__env,$__bladeCompiler) { $loop = (object) $__env->getLoopStack()[0] ?>
            <?php if (isset($component)) { $__componentOriginal602b228a887fab12f0012a3179e5b533 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal602b228a887fab12f0012a3179e5b533 = $attributes; } ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'edit('.e($studentGroup->id).')','class' => 'btn-sm btn-warning']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\Button::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:click' => 'delete('.e($studentGroup->id).')','wire:confirm' => 'Anda yakin ingin menghapus data ini?','class' => 'btn-sm btn-error']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal602b228a887fab12f0012a3179e5b533)): ?>
<?php $attributes = $__attributesOriginal602b228a887fab12f0012a3179e5b533; ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(empty($studentGroups)): ?>
                <tr>
...
<?php endif; ?>
        ...
        <div class="mt-4">
            <?php echo e($studentGroups->links()); ?>
