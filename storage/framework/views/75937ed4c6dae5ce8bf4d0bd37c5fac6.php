...
<?php $component = Mary\View\Components\Stat::resolve(['title' => 'Total Dosen','value' => $this->stats['totalDosen'],'icon' => 'o-academic-cap','description' => 'Dosen di prodi & cluster Anda'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
</div><?php /**PATH /Volumes/EXCHANGE/WebDev/FetAS/resources/views/livewire/prodi/dashboard.blade.php ENDPATH**/ ?>